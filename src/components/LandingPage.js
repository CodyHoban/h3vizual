            ...
            <Grid container direction="column" className={classes.mainContainer}>
                ...
                {/*-----Services Block-----*/}
                    <Grid 
                        container 
                        direction="row" 
                        justity={matchesSM ? "center" : undefined} 
                    ...
                    >
                        <Grid item style={{ marginLeft: matchesSM ? 0 : "5em", textAlign: matchesSM ? "center" : undefined }}>
                            ...
                            <Typography variant="subtitle1">
                                Complete digital solutions, from investifation to{" "}
                        ...
                        <Grid item>
                            <img className={classes.icon} alt="custon software icon" src={customSoftwareIcon} />
                        </Grid>
                    </Grid>
                </Grid>
            </Grid>
