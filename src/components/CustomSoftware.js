        ...
        <Grid container direction="column">
            ...
            >
                ...
                <Grid item container direction="column" className={classes.heading}>
                    <Grid item>
                        <Typography variant="h2" align={matchesSM ? "center" : undefined}>Custom Software Development</Typography>
                    </Grid>
                    <Grid item>
                        ...
                        <Typography align={matchesMD ? "center" : undefined} variant="body1" paragraph>
                            ...
                            Without using any software at ll you risk falling behind competitors and missing 
                            out on huge savings from increased efficiency.
                        </Typography>
                        <Typography align={matchesMD ? "center" : undefined} variant="body1" paragraph>
                            Our custom solutions are designed from the ground up with your needs, wants, 
                            and goals at the core. This is collaborative process produces finely tuned software 
                ...
                <Grid item className={classes.arrowContainer}>
                    ...
                    >
                        <img src={forwardArrow} alt="Forward to iOS/Android develoment page" />
                    </IconButton>
                </Grid>
                </Hidden>
            </Grid>
            ...
            >
                ...
                >
                    <Grid item container direction="column" md>
                        ...
                        <Grid item>
                            <Typography varient="body1" paragraph align={matchesSM ? "center" : undefined}>
                            ...
                            <Typography varient="body1" paragraph align={matchesSM ? "center" : undefined}>
                                By utilising digital forms and documents you can remove these obsolete 
                    ...
                    <Grid item container direction="column" md>
                        ...
                        <Grid item>
                            <Typography varient="body1" paragraph align="right">
                                ...
                                now, our application architecture ensures pain-free growth and reliability.
                            </Typography>
                        </Grid>
                    </Grid> 
                </Grid>
            ...
            >
                <Grid item container direction="column" alignItems="center">
                    ...
                    <Grid item className={classes.itemContainer}>
                        ...
                        <Typography variant="body1" paragraph align="center">
                            We can help you thoroughly examin all areas of your business to develop 
            ...
            >
                ...
                >
                    <Grid 
                        ...
                        md
                    >
                        <Lottie options={uxOptions} style={{maxWidth: 155, minHeight: 310}} />
                    </Grid>
                    <Grid item container direction="column" md>
                        <Grid item>
                        ...
                        <Grid item>
                            <Typography varient="body1" paragraph align={matchesSM ? "center" : "right"}>
                            ...
                            <Typography varient="body1" paragraph align={matchesSM ? "center" : "right"}>
                                By prioritizing users and the real ways they interact with technology we're 
                                able to develop unique, personable exeriences that solve problems 
