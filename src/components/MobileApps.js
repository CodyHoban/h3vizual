        ...
        <Grid container direction="column">
            ...
            >
                ...
                <Grid item container direction="column" className={classes.heading}>
                    <Grid item>
                        <Typography variant="h2" align={matchesSM ? "center" : undefined}>iOS/Android App Development</Typography>
                    </Grid>
                    <Grid item>
                        ...
                        <Typography align={matchesMD ? "center" : undefined} variant="body1" paragraph>
                            Whether you want an app for your customers, employees, or yourself, we ca build cross-platform 
                            native solutions for any part of your business process. This opens you up to a whole new world 
                            of possibilities by taking advantage of phone features like the camera, GPS, push notifications, and more.
                        </Typography>
                        <Typography align={matchesMD ? "center" : undefined} variant="body1" paragraph>
            ...
            >
                <Grid item container direction="column" md>
                    ...
                    <Grid item>
                        ...
                        <Typography align={matchesSM ? "center" : undefined} variant="body1" paragraph>
                            This allows you to extend you reach, reinvent interactions, and develop a stronger 
                            relatiionship with your users than ever before.
                        </Typography>
                    </Grid>
                </Grid>
                <Grid item md>
                ...
                <Grid item container direction="column" md>
                    ...
                    <Grid item>
                        <Typography  align={matchesSM ? "center" : "right"} variant="body1" paragraph>
                            Our cutting-edge development proess allows us to create apps for iPhone, 
                            Android, and tablets - all at the same time.
                        </Typography>
                        <Typography  align={matchesSM ? "center" : "right"} variant="body1" paragraph>
                            This significantly reduces costs and creates a more unified brand exerience 
                            across all devices.
                        </Typography>
                    </Grid>
                </Grid>
            ...
            >
                ...
                <Grid item container direction="column" alignItems="center" md>
                    <Grid item>
                        <Typography align="center" variant="h4" gutterBottom>Increase Engagment</Typography>
                    </Grid>
                    <Grid item>
